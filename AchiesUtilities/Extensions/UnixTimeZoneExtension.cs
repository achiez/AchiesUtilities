...
public static class UnixTimeZoneExtension
{
    ...
    {
        return ToLongWithTimeZone(unix, TimeZoneInfo.Local, format);
    }

    public static long ToLongWithTimeZone(this UnixTimeStamp unix, TimeZoneInfo info,
        UnixFormat format = UnixFormat.Seconds)
    {
